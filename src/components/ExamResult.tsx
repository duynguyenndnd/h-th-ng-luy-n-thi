              ...
              <div className="p-6 md:p-8">
                  ...
                  <div className="bg-slate-50 p-5 rounded-xl border border-slate-200 relative overflow-hidden group">
                    ...
                    <div className="mt-4 pt-4 border-t border-slate-200/60">
                       ...
                       >
                         <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C6.228 6.253 2 10.537 2 15.75c0 5.213 4.228 9.497 10 9.497s10-4.284 10-9.497c0-5.213-4.228-9.497-10-9.497z" />
                         </svg>
                         📖 Giải thích chi tiết
                       </button>
                    </div>
            ...
            <div className="p-5 border-b border-slate-100 flex justify-between items-center bg-slate-50/50 rounded-t-2xl">
              <h3 className="font-bold text-slate-800 flex items-center gap-3">
                <div className="p-2 bg-purple-100 text-purple-700 rounded-lg">
                   <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C6.228 6.253 2 10.537 2 15.75c0 5.213 4.228 9.497 10 9.497s10-4.284 10-9.497c0-5.213-4.228-9.497-10-9.497z" /></svg>
                </div>
                <div>
                   <div className="text-base">📖 Giải thích chi tiết</div>
                   <div className="text-xs text-slate-500 font-normal">Phân tích đầy đủ về câu hỏi này</div>
                </div>
              </h3>
